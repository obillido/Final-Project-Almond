...
<link href="${pageContext.request.contextPath}/resources/ticket/ticket.css" rel="stylesheet">

<div class="d1">
	<div class="align_center">
		<div class="d2">이용권충전<br>
			<a>내가 가진 캐시 :${uc.cash}</a><br>
			<a>대여권 : </a><br>
			<a>소장권 : </a><br>
		</div>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
	   			<form action="${pageContext.request.contextPath}/ticket/buy" method="post">
					<input type="hidden" name="usernum" value="유저번호: ${usernum}">
					<input type="hidden" name="contnum" value="작품번호: ${contnum}">
